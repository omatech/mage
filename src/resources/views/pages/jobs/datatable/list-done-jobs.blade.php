<table id="mage-done-jobs-datatable" class="table table-bordered table-hover display" style="width:100%">
    <thead>
        <tr>
            ...
            <th>@lang('backend.jobs-done.datatable.field.connection')</th>
            <th>@lang('backend.jobs-done.datatable.field.queue')</th>
            <th>@lang('backend.jobs-done.datatable.field.payload')</th>
            <th>@lang('backend.jobs-done.datatable.field.attempts')</th>

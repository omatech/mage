...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('mage.pages.users.index.title')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">@lang('mage.title')</a></li>
                        <li class="breadcrumb-item active">@lang('mage.pages.users.index.title')</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    @includeWhen(session()->has('status') && session('status') == 'created',
                        'mage::components.alerts.users.created')

                    @includeWhen(session()->has('status') && session('status') == 'updated',
                        'mage::components.alerts.users.updated')
